...
<body>
	...
	<form action="insertBalik.php" method="POST">
		<table align="center ">
			<tr>
				<td colspan="3" align="center" valign="middle">
					<label><h3>Balik Aral</h3></label>
				</td>
			</tr>
			<tr>
				<td class="col-stud">
			...
			<tr>
				<td colspan="3" align="center" valign="top">
						<label><h3>Balik Aral Information</h3></label>
						Last Grade Level: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input id="field" class="field" placeholder="Please enter your last grade level . . ." type="text" name="grlvl" required="" value="<?php if(isset($_POST['grlvl'])){ echo $grlvl; } ?>"><br><br>
						Last School Attended: &nbsp;
						<input id="field" class="field" placeholder="Please enter the last school you attended . . ." type="text" name="lstschool" required="" value="<?php if(isset($_POST['lstschool'])){ echo $lstschool; } ?>"><br><br>
						School Address: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input id="field" class="field" placeholder="Please enter the school address . . . " type="text" name="schooladd" required="" value="<?php if(isset($_POST['schooladd'])){ echo $schooladd; } ?>">
						<br><br><br><br>
				</td>
			</tr>
			<tr>
